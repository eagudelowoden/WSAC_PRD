...
router.post("/solicitar-subsanar", registrarActividad("Solicitar subsanación"), async (req, res, next) => {
...
// Subir corrección
router.post("/subir-correccion", upload.any(), async (req, res, next) => {
...
router.post("/solicitar-firma-contratos", registrarActividad("Solicitar firma de contratos"), async (req, res, next) => {
...
router.post("/subir-firmados", upload.any(), async (req, res, next) => {
  const { token } = req.body;
  try {
